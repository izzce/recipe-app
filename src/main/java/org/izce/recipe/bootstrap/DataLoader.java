...
public class DataLoader implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category chinese = categoryRepository.findByDescription("Chinese").get();
		...
		recipe1.setImageUrl("https://www.simplyrecipes.com/wp-content/uploads/2014/05/guacamole-horiz-a-1600-1024x729.jpg");
		...
		recipe2.setDescription("Red Velvet Cookies");
		...
		recipe2.setUrl("https://www.simplyrecipes.com/recipes/red_velvet_cookies/");
		recipe2.setImageUrl("https://www.simplyrecipes.com/wp-content/uploads/2019/01/Red-Velvet-Cookies-LEAD-02.jpg");
		recipe2.getCategories().add(mexican);
		recipe2.getCategories().add(chinese);
